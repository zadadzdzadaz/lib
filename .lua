--[[
    Milenium Library - Version Complète Corrigée
    Partie 1/4 : Core & Fonctions Utilitaires
    
    Made by @finobe (Enhanced & Fixed)
]]
...
function library:mouse_in_frame(uiobject)
    if not uiobject or not uiobject:IsA("GuiObject") then
        return false
    end
...
function library:apply_theme(instance, theme, property)
    if not instance or not themes.utility[theme] or not themes.utility[theme][property] then
        return
    end
...
function library:update_theme(theme, color)
    ...
    for property_name, property_table in pairs(themes.utility[theme]) do
        for idx, object in pairs(property_table) do
            if object[property_name] == themes.preset[theme] then
...
--[[
    Milenium Library - Partie 2/4
    Window, Tab, Section System
    
    COLLE CETTE PARTIE APRÈS LA PARTIE 1
]]
...
--[[
    Milenium Library - Partie 3/4
    UI Elements: Section, Toggle, Slider, Dropdown
    
    COLLE CETTE PARTIE APRÈS LA PARTIE 2
]]
...
function library:toggle(options)
    ...
    function cfg.set(bool)
        ...
        if cfg.folding and items["elements"] then
...
function library:slider(options)
    ...
    library:connection(uis.InputEnded, function(input)
        ...
        --[[
    Milenium Library - Partie 4/4 (FINALE)
    Dropdown, Label, Textbox, Button, Colorpicker, Keybind, Settings, List, Notifications
    
    COLLE CETTE PARTIE APRÈS LA PARTIE 3
]]
...
function library:textbox(options)
    ...
    do
        ...
        items["input"] = library:create("TextBox", {
            ...
            PlaceholderColor3 = rgb(72, 72, 72),
            CursorPosition = -1,
...
function library:colorpicker(options)
    ...
    do
        ...
        library:create("UIGradient", {
            ...
            Parent = items["sat"],
            Color = rgbseq{rgbkey(0, rgb(0, 0, 0)),
            --[[
    Milenium Library - Partie 5/5 (FINALE ABSOLUE)
    Fin du Colorpicker, Keybind, Settings, List, Notifications, Config System
    
    COLLE CETTE PARTIE APRÈS LA PARTIE 4
]]
...
function library:keybind(options)
    ...
    do
        ...
        local options_list = {"Hold", "Toggle", "Always"}
