    ...
    -- Library element functions
        function library:window(properties)
            local cfg = { 
                ...
                name = properties.name or properties.Name or "Original Milenium";
                game_name = properties.gameInfo or properties.game_info or properties.GameInfo or "edited by Y2K";
