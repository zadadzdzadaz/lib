...
local Library do
    ...
    local Themes = {
        ["Preset"] = {
            ["Background"] = FromRGB(10, 12, 20),
            ["Border"] = FromRGB(5, 6, 10),
            ["Inline"] = FromRGB(15, 18, 30),
            ["Hovered Element"] = FromRGB(25, 30, 50),
            ["Page Background"] = FromRGB(13, 15, 25),
            ["Outline"] = FromRGB(20, 25, 40),
            ["Element"] = FromRGB(20, 24, 35),
            ["Gradient"] = FromRGB(50, 100, 200),
            ["Text"] = FromRGB(220, 235, 255),
            ["Text Stroke"] = FromRGB(0, 0, 5),
            ["Placeholder Text"] = FromRGB(100, 120, 180),
